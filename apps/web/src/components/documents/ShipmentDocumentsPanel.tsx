  ...
  async function handleRefresh() {
    ...
    try {
      ...
      setError(
        requestError instanceof Error
          ? requestError.message
          : 'The documents could not be refreshed.',
      );
    } finally {
        ...
        {!isLoading && error && (
          <div className="rounded-xl border border-red-200 bg-red-50 p-5">
            ...
            <button
              ...
              className="mt-4 rounded-lg bg-red-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-red-800 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isRefreshing
                ? 'Trying again...'
                : 'Try Again'}
